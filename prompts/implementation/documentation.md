...
1. Inspect relevant code and open `loopfarm issue` items tied to the active implementation epic.
2. Update docs/prose so they match the current code and issue state.
3. Coordinate doc follow-ups through `loopfarm issue` (open/update issues as needed).
